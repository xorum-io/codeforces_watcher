...
object AnalyticsEvents {
    ...
    const val NEWS_REFRESH = "news_list_refresh"
    const val SHARE_APP = "news_share_app"
    const val APP_SHARED = "news_app_shared"
    const val NEWS_SHARED = "news_share"
    const val POST_OPENED = "post_opened"
    const val PINNED_POST_OPENED = "news_pinned_post_opened"
    const val PINNED_POST_CLOSED = "news_pinned_post_closed"
